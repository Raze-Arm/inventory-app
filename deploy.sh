...
fandogh  secret create --name spring-profiles-active -t environment-secret -f  SECRET_KEY=prod
fandogh  secret create --name jwt-secret-key -t environment-secret -f  SECRET_KEY=$JWT_SECRET_KEY
